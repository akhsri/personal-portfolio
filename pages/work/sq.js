...
const SQPage = () => {
  return (
    <div className={`${styles.companypagecontainer} container-fluid`}>
      <div className={`${styles.companypageheading} ${styles.centerheading} `}>
        Synergy Quantum
      </div>
      ...
      <div className={`${styles.projectcontainer}`}>
        ...
        <div>
          <p className={`${styles.projecttext}`}>
            ...
            Quantum Platform, they are given access to a dedicated Admin Console
            for their company.
          </p>
        </div>
        ...
        <p className={`${styles.projecttext}`}>
          ...
          Application. Developed the application from scratch and worked closely
          with other team members on implementation of the features.
        </p>
        <p className={`${styles.projecttext}`}>
      ...
      <div className={`${styles.projectcontainer}`}>
        ...
        <div>
          <p className={`${styles.projecttext}`}>
            A web application with post quantum safe storage and communication.
          </p>
        </div>
        <div className={`${styles.projectheading}`}>My Role</div>
        <p className={`${styles.projecttext}`}>
