        ...
        <div className={`${styles.projectcontainer}`}>
          ...
          <div>
            ...
            >
              ...
              <br />
              - Seamlessly schedule guards to different sites according to their
              availability and unavailability.
              <br />
              - Get digital reports from your guards, such as shift summaries or
              incident reports.
              <br />
            ...
            <p className={`${styles.projecttext}`}>
              ...
              the sites, shift scheduling and grid-view features on the frontend
              side using Angular.js.
            </p>
          </div>
        </div>
      </div>
